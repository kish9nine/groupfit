...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'WorkoutGroup.goal'
        db.delete_column(u'groups_workoutgroup', 'goal_id')
    ...
    def backwards(self, orm):
        # Adding field 'WorkoutGroup.goal'
        db.add_column(u'groups_workoutgroup', 'goal',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['groupfit.WorkoutGoal'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'groups.workoutgroup': {
            ...
            'goal': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'groups'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['groupfit.WorkoutGoal']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
