...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WorkoutGoal.achieved'
        db.add_column(u'groupfit_workoutgoal', 'achieved',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WorkoutGoal.achieved'
        db.delete_column(u'groupfit_workoutgoal', 'achieved')
