...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'users_userprofile_groups')
        ...
        db.create_unique(m2m_table_name, ['userprofile_id', 'workoutgroup_id'])

        # Adding M2M table for field tags on 'UserProfile'
        m2m_table_name = db.shorten_name(u'users_userprofile_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'users.userprofile'], null=False)),
        ...
        # Adding M2M table for field playlists on 'UserProfile'
        m2m_table_name = db.shorten_name(u'users_userprofile_playlists')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'users.userprofile'], null=False)),
            ('playlist', models.ForeignKey(orm[u'playlists.playlist'], null=False))
        ))
        db.create_unique(m2m_table_name, ['userprofile_id', 'playlist_id'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'users_userprofile_groups'))

        # Removing M2M table for field tags on 'UserProfile'
        db.delete_table(db.shorten_name(u'users_userprofile_tags'))

        # Removing M2M table for field playlists on 'UserProfile'
        db.delete_table(db.shorten_name(u'users_userprofile_playlists'))
    ...
    models = {
        ...
        u'groups.workoutgroup': {
            ...
            'goal': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['groupfit.WorkoutGoal']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
