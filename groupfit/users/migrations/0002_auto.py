...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field goals on 'UserProfile'
        m2m_table_name = db.shorten_name(u'users_userprofile_goals')
        ...
        db.create_unique(m2m_table_name, ['userprofile_id', 'workoutgoal_id'])


    def backwards(self, orm):
        # Removing M2M table for field goals on 'UserProfile'
        db.delete_table(db.shorten_name(u'users_userprofile_goals'))
