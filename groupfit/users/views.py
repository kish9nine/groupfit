...
from users.forms import RegisterForm, PasswordForm, EditUserProfileForm, PrivacyForm
    ...
    if request.method == 'POST':
        ...
        if create_user_form.is_valid() and confirm_password_form.is_valid() and privacy_form.is_valid():
            ...
            if pw == confirm_pw and not email_overlap:
                ...
                new_user.userprofile.privacy = privacy_setting
        ...
        if 'submit-new-profile' in request.POST:
            ...
            if edit_profile_form.is_valid():
                ...
                if privacy == "Private" or privacy == "Public":
                    request.user.userprofile.privacy = privacy
